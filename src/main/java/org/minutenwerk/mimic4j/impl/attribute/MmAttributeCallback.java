...
public interface MmAttributeCallback<ATTRIBUTE_TYPE, VIEW_TYPE> extends MmBaseCallback {
   ...
   *
   * @param   dataModelValue  The data model value to be converted.
   *
   * @return  The converted value of type VIEW_TYPE.
   *
   * @throws  MmDataModelConverterException  In case of the conversion failed.
   */
  public VIEW_TYPE callbackMmConvertDataModelToViewModel(ATTRIBUTE_TYPE dataModelValue) throws MmDataModelConverterException;

  /**
   * Converts view value of type VIEW_TYPE to value of type ATTRIBUTE_TYPE.
   *
   * @param   viewModelValue  The view value to be converted.
   *
   * @return  The converted value of type ATTRIBUTE_TYPE.
   *
   * @throws  MmViewModelConverterException  In case of the conversion failed.
   */
  public ATTRIBUTE_TYPE callbackMmConvertViewModelToDataModel(VIEW_TYPE viewModelValue) throws MmViewModelConverterException;
   ...
   */
  public int callbackMmGetMaxLength(int passThroughValue);
   ...
   */
  public MmAttributeAccessor<?, ATTRIBUTE_TYPE> callbackMmGetModelAccessor(MmModelAccessor<?, ?> parentAccessor);
   ...
   */
  public boolean callbackMmIsRequired(boolean passThroughValue);

  /**
   * Semantic validation of data model value of type ATTRIBUTE_TYPE.
   *
   * @param   dataModelValue  The data model value to be validated.
   *
   * @throws  MmValidatorException  In case of validation fails.
   */
  public void callbackMmValidateDataModel(ATTRIBUTE_TYPE dataModelValue) throws MmValidatorException;
