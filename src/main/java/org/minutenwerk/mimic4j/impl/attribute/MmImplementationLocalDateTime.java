...
public class MmImplementationLocalDateTime
  extends MmBaseAttributeImplementation<MmLocalDateTime, MmConfigurationLocalDateTime, MmLocalDateTimeAnnotation, LocalDateTime, String> {
   ...
   */
  @Override
  protected MmConfigurationLocalDateTime onConstructConfiguration(MmLocalDateTimeAnnotation pAnnotation) {
    if (pAnnotation != null) {
      return new MmConfigurationLocalDateTime(pAnnotation);
    } else {
      return new MmConfigurationLocalDateTime();
    }
  }
