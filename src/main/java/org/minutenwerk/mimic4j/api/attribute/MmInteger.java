...
public class MmInteger extends MmBaseAttributeDeclaration<MmImplementationInteger, Integer, String> {
   ...
   * @see      $HeadURL:http://saas1212sr.saas-secure.com/svn/saturn/org.minutenwerk.mimic4j.core/trunk/src/main/java/org/minutenwerk/mimic4j/api/attribute/MmInteger.java\$
   */
